...
module.exports = {
    ...
    AFN: process.env.ALL_CAPTION === undefined ? 'Made By M6858' : process.env.ALL_CAPTION,
    ...
    GIF_WEL: process.env.GIF_WEL === undefined ? 'https://c.tenor.com/QNtFLycfQiAAAAPo/pika-M6858.mp4' : process.env.GIF_WEL,
    ...
    BOTSK: process.env.BOT_NAME === undefined ? 'M6858 𝐁𝐎𝐓' : process.env.BOT_NAME,
